...
Route::post('konsumen/tip/{id}', 
[App\Http\Controllers\konsumen\JualController::class, 'posttip'])
->middleware('can:isKonsumen');

Route::post('kurir/tip/{id}', [App\Http\Controllers\kurir\JualController::class, 
'posttip'])->middleware('can:isKurir');
